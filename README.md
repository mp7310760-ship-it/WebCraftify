...
<input type="text" id="text" placeholder="Enter Hindi text">
<button onclick="translate()">Convert</button>
<p id="result"></p>

<h2>Publish Book</h2>
<textarea id="book"></textarea>
<button onclick="addBook()">Publish</button>
...
function translate() {
    ...
    fetch(`http://localhost:8080/api/translate?text=${text}`)
    .then(res => res.json())
    .then(data => {
